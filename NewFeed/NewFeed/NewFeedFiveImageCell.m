...
@interface NewFeedFiveImageCell()
...
@implementation NewFeedFiveImageCell
...
- (void)setupEventSelectImage
{
    ...
    //Event Img5
    UITapGestureRecognizer *tapImg5 =
    [[UITapGestureRecognizer alloc] initWithTarget:self
                                            action:@selector(actionSelectImg5:)];
    [self.imv_5 addGestureRecognizer:tapImg5];
}
...
//Select image5
- (void)actionSelectImg5:(UITapGestureRecognizer *)recognizer
{
    if (self.eventSelectImg5)
    {
        self.eventSelectImg5();
    }
}
...
- (void)fillDataForCell
{
    ...
    self.imv_5.image = [UIImage imageNamed:@"macbook.jpg"];
